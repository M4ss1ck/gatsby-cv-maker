      ...
      <ul className="languages">
        {languages.map(lng => (
          <li
            ...
            className={
              language === lng
                ? "text-center text-sm lg:text-lg py-4 font-montserrat cursor-pointer outline outline-blue-700 outline-1 text-blue-700 dark:text-blue-700  inline-flex items-center px-2 pt-2 pb-2 font-medium leading-5 transition duration-250 ease-in-out mx-2 rounded-lg"

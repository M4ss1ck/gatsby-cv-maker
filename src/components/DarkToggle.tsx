      ...
      {({ theme, toggleTheme }: Props) => {
		...
		c1.258,0,2.366,0.59,3.104,1.494c0.562,0.69,0.914,1.562,0.914,2.521C37.755,26.945,35.958,28.743,33.74,28.743z"
            ...
            <select
              ...
              className="inline-flex items-center px-2 py-4 pt-2 pb-2 m-2 mx-2 text-sm font-medium leading-5 text-center transition ease-in-out cursor-pointer text-primario border-primario hover:text-secundario hover:bg-primario rounded-xl bg-fondo lg:text-lg font-montserrat outline outline-primario outline-1 duration-250"
            >
